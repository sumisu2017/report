...
<footer class="bg-dark text-white fixed-bottom">
    <div class="container">
        <div class="my-3 d-none d-sm-block">
            八卦是《易經》的基本概念，可代表一切自然現象的動靜狀態，每個卦由三個爻组成。八卦的項目組合，可代表各種自然現象或動態，分別為“天、地、水、火、雷、風、山、澤”，卦名則稱“乾、坤、坎、離、震、巽、艮、兌”。 </div>
        <div class="my-2 d-block d-sm-none text-center">《易經》八卦</div>
    </div>
</footer>
